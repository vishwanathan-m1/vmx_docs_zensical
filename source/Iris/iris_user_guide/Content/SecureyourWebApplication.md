...
Before you begin, [generate RSA keypair](ApplicationSecurity.md?h=voltmxlicen#rsa-key-pair-generation-encryption-and-usage) and provide it to the Volt MX Security team to obtain the securejs.properties file from Volt MX Security team. For instructions on generating encryption keys, see [Encryption Key Generation](ApplicationSecurity.md#rsa-key-pair-generation-encryption-and-usage).
...
Before you begin, [generate RSA keypair](ApplicationSecurity.md?h=voltmxlicen#rsa-key-pair-generation-encryption-and-usage) and provide it to the Volt MX Security team to obtain the securejs.properties file from Volt MX Security team.
