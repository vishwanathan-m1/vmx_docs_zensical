...
> **NOTE:** For Android, to enable this feature, add the following code in the `<workspace location>/<project name>`/androidbuild.properties file.
...
| TEXTBOX_TEXT_CONTENT_TYPE_USERNAME         | Use this value when the TextBox widget is used to specify an account or a login name. When you use this value, the suggestions for username are available. Applicable from iOS 11.0 onwards. |
| TEXTBOX_TEXT_CONTENT_TYPE_PASSWORD         | Use this value when the TextBox widget is used to type a password. When you use this value, the suggestions for password are available. Applicable from iOS 11.0 onwards.        |
| TEXTBOX_TEXT_CONTENT_TYPE_OTP              | Use this value when the TextBox widget is used to specify a single factor SMS login code or OTP. Suggestions for OTP provided only if system keyboard is in use. From iOS 12.0 onwards.|
| TEXTBOX_TEXT_CONTENT_TYPE_NAME             | Use this value when the TextBox widget is used to specify the full name of a person. The system may suggest contact names.                                                       |
| TEXTBOX_TEXT_CONTENT_TYPE_NAME_PREFIX      | Use this value when the TextBox widget is used to specify Prefix for a name (e.g., Mr., Ms., Dr.).                                                                              |
| TEXTBOX_TEXT_CONTENT_TYPE_GIVEN_NAME       | Use this value when the TextBox widget is used to specify the First name or given name of a person.                                                                             |
| TEXTBOX_TEXT_CONTENT_TYPE_MIDDLE_NAME      | Use this value when the TextBox widget is used to specify the Middle name of a person.                                                                                          |
| TEXTBOX_TEXT_CONTENT_TYPE_FAMILY_NAME      | Use this value when the TextBox widget is used to specify the Last name or family name of a person.                                                                             |
| TEXTBOX_TEXT_CONTENT_TYPE_NAME_SUFFIX      | Use this value when the TextBox widget is used to specify Suffix for a name (e.g., Jr., Sr., III).                                                                              |
| TEXTBOX_TEXT_CONTENT_TYPE_FULL_STREET_ADDRESS | Use this value when the TextBox widget is used to specify Complete street address including house number and street name.                                                     |
| TEXTBOX_TEXT_CONTENT_TYPE_STREET_ADDRESS_LINE2 | Use this value when the TextBox widget is used to specify the Second line of street address (e.g., apartment, suite, unit).                                                    |
| TEXTBOX_TEXT_CONTENT_TYPE_SUBLOCALITY      | Use this value when the TextBox widget is used to specify Neighborhood, district, or other sublocality information.                                                             |
| TEXTBOX_TEXT_CONTENT_TYPE_EXTENDED_ADDRESS | Use this value when the TextBox widget is used to specify Additional address information (e.g., building, floor).                                                               |
| TEXTBOX_TEXT_CONTENT_TYPE_COUNTRY_NAME     | Use this value when the TextBox widget is used to specify Country name for address forms.                                                                                       |
| TEXTBOX_TEXT_CONTENT_TYPE_POSTAL_CODE      | Use this value when the TextBox widget is used to specify Postal code or ZIP code for address forms.                                                                            |
| TEXTBOX_TEXT_CONTENT_TYPE_TELEPHONE_NUMBER | Use this value when the TextBox widget is used to specify a Telephone number. The system may suggest numbers from contacts.                                                    |
| TEXTBOX_TEXT_CONTENT_TYPE_EMAIL_ADDRESS    | Use this value when the TextBox widget is used to specify an Email address. The system may suggest saved email addresses.                                                      |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_NUMBER | Use this value when the TextBox widget is used to specify Credit card number for payment forms.                                                                                |
| TEXTBOX_TEXT_CONTENT_TYPE_FLIGHT_NUMBER    | Use this value when the TextBox widget is used to specify Flight number for travel forms. Applicable from iOS 15.0 onwards.                                                    |
| TEXTBOX_TEXT_CONTENT_TYPE_BIRTHDATE        | Use this value when the TextBox widget is used to specify Birthdate in date format (YYYY-MM-DD). Applicable from iOS 17.0 onwards.                                            |
| TEXTBOX_TEXT_CONTENT_TYPE_BIRTHDATE_DAY    | Use this value when the TextBox widget is used to specify Day of birth (DD). Applicable from iOS 17.0 onwards.                                                                  |
| TEXTBOX_TEXT_CONTENT_TYPE_BIRTHDATE_MONTH  | Use this value when the TextBox widget is used to specify Month of birth (MM). Applicable from iOS 17.0 onwards.                                                                |
| TEXTBOX_TEXT_CONTENT_TYPE_BIRTHDATE_YEAR   | Use this value when the TextBox widget is used to specify Year of birth (YYYY). Applicable from iOS 17.0 onwards.                                                               |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_SECURITY_CODE | Use this value when the TextBox widget is used to specify Credit card security code (CVV/CVC). Applicable from iOS 17.0 onwards.                                         |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_EXPIRATION | Use this value when the TextBox widget is used to specify Credit card expiration date (MM/YY or MM/YYYY). Applicable from iOS 17.0 onwards.                                   |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_EXPIRATION_MONTH | Use this value when the TextBox widget is used to specify Credit card expiration month (MM). Applicable from iOS 17.0 onwards.                                              |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_EXPIRATION_YEAR | Use this value when the TextBox widget is used to specify Credit card expiration year (YYYY). Applicable from iOS 17.0 onwards.                                               |
| TEXTBOX_TEXT_CONTENT_TYPE_NEW_PASSWORD     | Use this value when the TextBox widget is used to specify a new password for account creation or password change.                                                               |
| TEXTBOX_TEXT_CONTENT_TYPE_2FA_APP_OTP      | Use this value when the TextBox widget is used to specify a one-time password from a 2FA app. In iOS it maps to OTP.                                                             |
| TEXTBOX_TEXT_CONTENT_TYPE_UPI_VPA           | Use this value when the TextBox widget is used to specify Unified Payments Interface (UPI) Virtual Payment Address. Only available in Android.                                |
| TEXTBOX_TEXT_CONTENT_TYPE_WIFI_PASSWORD    | Use this value when the TextBox widget is used to specify WiFi network password. In iOS it maps to PASSWORD.                                                                    |
| TEXTBOX_TEXT_CONTENT_TYPE_GIFT_CARD_NUMBER | Use this value when the TextBox widget is used to specify Gift card number for redemption. In iOS it maps to CARD NUMBER.                                                       |
| TEXTBOX_TEXT_CONTENT_TYPE_GIFT_CARD_PIN    | Use this value when the TextBox widget is used to specify Gift card PIN for redemption. Only available in Android.                                                              |
| TEXTBOX_TEXT_CONTENT_TYPE_LOYALTY_ACCOUNT_NUMBER | Use this value when the TextBox widget is used to specify Loyalty program account number. Only available in Android.                                                           |
| TEXTBOX_TEXT_CONTENT_TYPE_PROMO_CODE       | Use this value when the TextBox widget is used to specify Promotional code for discounts or offers. Only available in Android.                                                  |
| TEXTBOX_TEXT_CONTENT_TYPE_GENDER           | Use this value when the TextBox widget is used to specify Gender information (e.g., male, female, other). Only available in Android.                                           |
| TEXTBOX_TEXT_CONTENT_TYPE_ADDRESS_STATE    | Use this value when the TextBox widget is used to specify State or province for address forms.                                                                                   |
| TEXTBOX_TEXT_CONTENT_TYPE_STREET_ADDRESS_LINE1 | Use this value when the TextBox widget is used to specify the First line of street address (e.g., house number, street name).                                                  |
| TEXTBOX_TEXT_CONTENT_TYPE_EXTENDED_POSTAL_CODE | Use this value when the TextBox widget is used to specify Extended postal code (e.g., ZIP+4). In iOS it maps to POSTAL_CODE.                                                   |
| TEXTBOX_TEXT_CONTENT_TYPE_PHONE_COUNTRY_CODE | Use this value when the TextBox widget is used to specify Country code for phone numbers. Only available in Android.                                                            |
| TEXTBOX_TEXT_CONTENT_TYPE_PHONE_NUMBER_DEVICE | Use this value when the TextBox widget is used to specify Device phone number. In iOS it maps to a Telephone number.                                                           |
| TEXTBOX_TEXT_CONTENT_TYPE_PHONE_NATIONAL   | Use this value when the TextBox widget is used to specify National phone number format. In iOS it maps to a Telephone number.                                                   |
| TEXTBOX_TEXT_CONTENT_TYPE_EMAIL_OTP        | Use this value when the TextBox widget is used to specify One-time password sent via email. In iOS it maps to OTP.                                                              |
| TEXTBOX_TEXT_CONTENT_TYPE_FLIGHT_CONFIRMATION_CODE | Use this value when the TextBox widget is used to specify Flight confirmation code for travel forms. Only available in Android.                                              |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_EXPIRATION_DAY | Use this value when the TextBox widget is used to specify Day of credit card expiration (DD). Only available in Android.                                                      |
| TEXTBOX_TEXT_CONTENT_TYPE_NICKNAME         | Use this value when the TextBox widget is used to specify Nickname or informal name. Only available in iOS.                                                                     |
| TEXTBOX_TEXT_CONTENT_TYPE_JOB_TITLE        | Use this value when the TextBox widget is used to specify Job title or occupation. Only available in iOS.                                                                        |
| TEXTBOX_TEXT_CONTENT_TYPE_ORGANIZATION_NAME | Use this value when the TextBox widget is used to specify the name of an organization or company. Only available in iOS.                                                       |
| TEXTBOX_TEXT_CONTENT_TYPE_LOCATION         | Use this value when the TextBox widget is used to specify General location information (e.g., city, area). Only available in iOS.                                              |
| TEXTBOX_TEXT_CONTENT_TYPE_ADDRESS_CITY     | Use this value when the TextBox widget is used to specify City for address forms. Only available in iOS.                                                                         |
| TEXTBOX_TEXT_CONTENT_TYPE_ADDRESS_CITY_AND_STATE | Combined city and state for address forms. Only available in iOS.                                                                                                               |
| TEXTBOX_TEXT_CONTENT_TYPE_URL              | Use this value when the TextBox widget is used to specify Website URL. The system may suggest saved URLs. Only available in iOS.                                                |
| TEXTBOX_TEXT_CONTENT_TYPE_SHIPMENT_TRACKING_NUMBER | Use this value when the TextBox widget is used to specify Shipment tracking number for deliveries. Applicable from iOS 15.0 onwards. Only available in iOS.                   |
| TEXTBOX_TEXT_CONTENT_TYPE_DATE_TIME        | Use this value when the TextBox widget is used to specify Date and time information. Applicable from iOS 15.0 onwards. Only available in iOS.                                  |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_NAME | Use this value when the TextBox widget is used to specify Name on credit card. Applicable from iOS 17.0 onwards. Only available in iOS.                                        |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_GIVEN_NAME | Use this value when the TextBox widget is used to specify a given name on a credit card. Applicable from iOS 17.0 onwards. Only available in iOS.                               |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_MIDDLE_NAME | Use this value when the TextBox widget is used to specify a Middle name on a credit card. Applicable from iOS 17.0 onwards. Only available in iOS.                              |
| TEXTBOX_TEXT_CONTENT_TYPE_CREDIT_CARD_FAMILY_NAME | Use this value when the TextBox widget is used to specify a Family name on a credit card. Applicable from iOS 17.0 onwards. Only available in iOS.                              |
| TEXTBOX_TEXT_CONTENT_TYPE_CELLULAR_EID     | Use this value when the TextBox widget is used to specify a cellular EID. Applicable from iOS 17.4 onwards. Only available in iOS.                                             |
| TEXTBOX_TEXT_CONTENT_TYPE_CELLULAR_IMEI    | Use this value when the TextBox widget is used to specify a cellular IMEI. Applicable from iOS 17.4 onwards. Only available in iOS.                                            |
