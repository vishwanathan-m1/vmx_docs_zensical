Volt MX Iris V10 Windows Install Guide (Prerequisites)
=======================================================
...
| --- | --- |
| Windows 10 and later, Windows 8.1 Update. Supports 64-bit Operating Systems | Installer File (Mandatory) |
...
To download Volt Iris, follow these steps:

1. Log in to [MHS](https://my.hcltechsw.com/downloads). MHS uses the same HCLSoftware ID and single-sign on (SSO) system used for other portals such as the HCLSoftware Customer Support. [See here](https://support.hcl-software.com/csm?id=kb_article&sysparm_article=KB0069114) for the instructions on obtaining a user name and password.

2. After you logged in, navigate to **HCL Volt MX**, and then select **Volt Iris**.

3. Select the correct release version, and click **Direct Download**.
