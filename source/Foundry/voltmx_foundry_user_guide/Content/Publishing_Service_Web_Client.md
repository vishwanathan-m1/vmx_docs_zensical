...
> **_Note:_** After publishing the Web Client from Volt Iris, the default Web Client version does not automatically update in Volt Foundry. To publish the latest version to **Volt Foundry Cloud**, go to **CONFIGURE & PUBLISH**, select the latest Web Client version, and click **PUBLISH**. See [Publish the App from Volt MX Foundry](../../../Iris/iris_user_guide/Content/PublishVoltMXFoundryServicesApp.md#publish-the-app-from-volt-mx-foundry) for full instructions.
