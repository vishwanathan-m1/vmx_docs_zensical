...
actions:
     <font color="#008000">- servicesManager.invokeIntegration("RulesIntegrationService", "SendSms")</font></code></pre>
        ...
        <blockquote>
        <em><b>Note:</b></em> You cannot test a service invoked within a Rule from the Foundry Console. This functionality is available only through App Services, as the Foundry Console environment does not include the complete service metadata required for execution.
        </blockquote>
      </td>
    </tr>
  </table>
